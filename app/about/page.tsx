    ...
    <div>
      ...
      <section style={{ background: colors.navy, padding: '72px 32px 64px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          ...
          <h1 style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 38, color: '#fff', margin: '0 0 18px', lineHeight: 1.25 }}>
      ...
      <section style={{ maxWidth: 1280, margin: '0 auto', padding: '80px 32px' }}>
        <div className="glb-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginBottom: 72 }}>
          <div style={{ background: '#fff', border: '1px solid rgba(10,25,48,.08)', borderRadius: 16, padding: 36 }}>
            ...
            <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, fontSize: 19, color: colors.textDark, lineHeight: 1.5, margin: 0 }}>
          ...
          <div style={{ background: '#fff', border: '1px solid rgba(10,25,48,.08)', borderRadius: 16, padding: 36 }}>
            <div style={{ fontSize: 13, fontWeight: 600, color: colors.blue, letterSpacing: '.05em', textTransform: 'uppercase', marginBottom: 12 }}>
              Vision
            </div>
            <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, fontSize: 19, color: colors.textDark, lineHeight: 1.5, margin: 0 }}>
        ...
        <div style={{ marginBottom: 24 }}>
          <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 26, color: colors.textDark, marginBottom: 32, textAlign: 'center' }}>
            Our values
          </div>
      ...
      <section style={{ background: colors.navyMid }}>
        <div className="glb-grid" style={{ maxWidth: 1280, margin: '0 auto', padding: '72px 32px', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
          <div>
            <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 22, color: '#fff', marginBottom: 10 }}>Industry focus</div>
          ...
          <div>
            <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 22, color: '#fff', marginBottom: 10 }}>Technical expertise</div>
            <p style={{ fontSize: 14.5, color: 'rgba(255,255,255,.6)', lineHeight: 1.65, margin: 0 }}>
              Software development, ERP, cybersecurity, and physical security under one roof, so systems work together by design.
            </p>
          </div>
          <div>
            <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 22, color: '#fff', marginBottom: 10 }}>Local understanding</div>
            <p style={{ fontSize: 14.5, color: 'rgba(255,255,255,.6)', lineHeight: 1.65, margin: 0 }}>
