...
export const products: Product[] = [
  {
    ...
    listingDesc:
      "Manage your entire fuel operation from one platform—customers, stock, sales, and detailed financial reporting.",
    ...
    detail: {
      ...
      closingSubtitle:
        "Schedule a tailored walkthrough to see how our ERP fits your specific operation.",
  ...
  },
  {
    ...
    listingDesc:
      "Fast, reliable sales interface designed specifically for forecourt cashiers and station managers.",
    ...
    detail: {
      ...
      heroSubtitle:
        "A high-speed, durable sales interface built to handle the heavy traffic and unique requirements of modern gas station forecourts.",
      sectionHeading: "Engineered for Forecourt Speed and Accuracy",
      sectionBody:
        "During peak hours, your cashiers need a system that is both fast and foolproof. Our Gas Station POS simplifies complex transactions, manages shift changes with precision, and provides managers with instant branch-level reporting. It integrates directly with forecourt hardware to ensure that every litre pumped is a litre paid for, significantly reducing human error and unauthorized fuel dispensing. The interface is designed for high-glare environments and can be operated with minimal training.",
      customers: [
      ...
      closingSubtitle:
        "See why station owners prefer our fast, reliable, and secure POS solution.",
      ctaLabel: "Request a Demo",
    },
  },
  {
    ...
    listingDesc:
      "Issue and manage fuel cards for customers, drivers, and fleets with automated spending limits.",
  ...
  },
  {
    ...
    listingDesc:
      "Set precise fuel allowances by employee, vehicle, or department with automated approval workflows.",
    detail: {
      icon: Gauge,
      iconBg,
      iconColor,
  ...
  },
  {
    ...
    listingDesc:
      "Track your cylinder inventory, deposits, and returns in real-time to prevent stock loss.",
  ...
  },
  {
    ...
    listingDesc:
      "Specialised management for tonnage-based gas delivery, including contract tracking and invoicing.",
    detail: {
      icon: Truck,
      iconBg,
      iconColor,
  ...
  },
  {
    ...
    listingDesc:
      "Optimise delivery routes and track your fleet live to improve efficiency and customer service.",
    detail: {
      icon: Route,
      iconBg,
      iconColor,
  ...
  },
  {
    ...
    listingDesc:
      "Verify field work and site visits using GPS check-ins and real-time photo evidence.",
    ...
    detail: {
      ...
      closingSubtitle:
        "See how our location-based tools can improve your field operations.",
      ctaLabel: "Request a Demo",
    },
  },
  {
    ...
    listingDesc:
      "Stay ahead of equipment failures with preventive maintenance schedules and work order tracking.",
    detail: {
      icon: Wrench,
      iconBg,
      iconColor,
  ...
  },
  {
    ...
    listingDesc:
      "Provide your customers with a self-service app to place orders, view invoices, and track accounts.",
    detail: {
      icon: Smartphone,
      iconBg,
      iconColor,
      ...
      heroSubtitle:
        "A modern self-service experience for your gas, fuel, and service customers.",
  ...
  },
  {
    ...
    listingDesc:
      "Get a clear, real-time overview of sales, security, and operations through intuitive executive dashboards.",
    ...
    detail: {
      ...
      heroSubtitle:
        "Executive-level insights that turn your operational data into a competitive advantage.",
      sectionHeading: "Decision-Ready Data for Energy Executives",
      sectionBody:
        "Fuel and energy businesses generate massive amounts of data every day, but much of it is often trapped in spreadsheets or individual branch systems. Our Business Intelligence Dashboard pulls data from your ERP, POS, and logistics systems into a single, intuitive interface. It is designed for owners and regional managers who need answers fast—not analysts who spend hours cleaning data. See your most profitable branches, monitor stock movements, and identify operational risks at a glance. It provides the clarity needed to lead in a fast-moving energy market.",
      customers: [
        "Business Owners",
