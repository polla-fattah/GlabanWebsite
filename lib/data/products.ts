...
export const products: Product[] = [
  ...
  {
    slug: 'forecourt-management',
    name: 'Forecourt Management System',
    category: 'Forecourt',
    listingIcon: '⛽',
    listingDesc: 'Station-level control over pumps, tanks, price signs, and reconciliation.',
    detail: {
      icon: 'fa-solid fa-gas-pump',
      iconBg,
      iconColor,
      eyebrow: 'Product · Forecourt',
      heroSubtitle: 'Station-level operational control beyond the till — pumps, tanks, price signs, and multi-branch reconciliation.',
      sectionHeading: 'See the whole station, not just the till',
      sectionBody: 'Forecourt Management sits alongside POS and ERP to give back-office teams visibility into pumps, dispensers, tanks, and price signage across every branch.',
      customers: ['Gas stations', 'Station networks', 'Fuel depots', 'Refineries'],
      features: [
        'Pump integration direction', 'Fuel dispenser monitoring direction', 'Tank level integration direction',
        'Price sign management direction', 'Back-office reporting', 'Multi-branch station dashboard',
        'Sales and stock reconciliation', 'Integration with POS and ERP',
      ],
      closingHeading: 'Get full visibility over your forecourt',
      ctaLabel: 'Request a Demo',
    },
  },
  {
