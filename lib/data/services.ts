...
export const services: Service[] = [
  {
    ...
    listingDesc:
      "Tailored web, mobile, and desktop applications built to solve your specific operational challenges.",
    detail: {
      icon: Code,
      iconBg: orangeBg,
  ...
  },
  {
    ...
    listingDesc:
      "Professional rollout of the Fuel ERP Platform, from business analysis to final staff training.",
    detail: {
      icon: Settings,
      iconBg: orangeBg,
      iconColor: orangeColor,
  ...
  },
  {
    ...
    listingDesc:
      "Complete station setup, including POS installation, cashier training, and manager reporting.",
    detail: {
      icon: Monitor,
      iconBg: orangeBg,
      iconColor: orangeColor,
      ...
      steps: [
        ...
        "User setup",
        "Product setup",
        "Printer setup direction",
        "Shift workflow configuration",
        "Cashier training",
        "Manager training",
        "Reporting setup",
        "Pump/forecourt integration direction",
        "Ongoing support",
      ],
  ...
  },
  {
    ...
    listingDesc:
      "Modernise your logistics with integrated dispatch and tonnage-based delivery workflows.",
    detail: {
      icon: Truck,
      iconBg: orangeBg,
      iconColor: orangeColor,
      eyebrow: "Service · Implementation",
      heroSubtitle:
        "We roll out dispatch, propane, and bulk gas delivery workflows so your drivers and planners adopt them from day one.",
  ...
  },
  {
    ...
    listingDesc:
      "Secure your web applications, servers, ERP platforms, and business networks.",
    detail: {
      icon: ShieldCheck,
      iconBg: orangeBg,
      iconColor: orangeColor,
      ...
      heroSubtitle:
        "Protect the systems your fuel business runs on — from your website to your ERP and POS access controls.",
  ...
  },
  {
    ...
    listingDesc:
      "Protect your critical infrastructure, including pumps, tanks, and industrial control networks.",
    detail: {
      icon: Factory,
      iconBg: orangeBg,
      iconColor: orangeColor,
      ...
      heroSubtitle:
        "A dedicated assessment covering the operational technology unique to fuel and energy sites — pumps, tanks, and CCTV networks.",
      sectionHeading: "Protecting Critical Operational Technology (OT)",
      sectionBody:
        "Industrial networks at refineries and fuel depots are often overlooked by traditional IT security. Our Industrial & OT Cybersecurity Assessment is designed specifically for these high-risk environments. We review the security of your pump controllers, tank monitoring systems, and CCTV networks, which are often the weakest entry points for intruders. Our assessment identifies insecure remote access points and legacy hardware vulnerabilities, providing you with a technical remediation plan to air-gap and secure your critical operational assets.",
      ctaLabel: "Request an Assessment",
      layout: "checklist",
      items: [
        "Industrial network review",
        "Remote access security review",
        "Pump and tank system exposure review",
        "CCTV/NVR network security review",
      ...
      disclaimer:
        "This is an assessment and protection service; it does not include industrial engineering or control-system reconfiguration unless separately scoped.",
  ...
  },
  {
    ...
    listingDesc:
      "Professional camera installation, monitoring, and control-room setup for every site.",
    detail: {
      icon: Video,
      iconBg: orangeBg,
      iconColor: orangeColor,
      ...
      items: [
        ...
        "Fuel pump area monitoring",
        "Cashier and counter monitoring",
        "Warehouse and tank area monitoring",
        "Alarm integration",
  ...
  },
  {
    ...
    listingIcon: Badge,
    image: "/images/services/s8.png",
    listingDesc:
      "Secure your premises with biometric access control, staff ID cards, and automated attendance.",
    detail: {
      icon: Badge,
      iconBg: orangeBg,
      iconColor: orangeColor,
      ...
      items: [
        ...
        "Visitor logs",
        "Shift attendance",
        "HR or ERP integration direction",
        "Reports by branch or site",
        "Security alerts",
      ],
  ...
  },
  {
    ...
    listingIcon: Truck,
    image: "/images/services/s9.png",
    listingDesc:
      "Real-time GPS tracking and performance monitoring for your delivery and service vehicles.",
    detail: {
      icon: Truck,
      iconBg: orangeBg,
      iconColor: orangeColor,
      ...
      items: [
        ...
        "Fuel consumption tracking direction",
  ...
  },
  {
    ...
    listingDesc:
      "Secure cloud hosting with automated daily backups and comprehensive disaster recovery plans.",
    detail: {
      icon: Cloud,
      iconBg: orangeBg,
      iconColor: orangeColor,
      ...
      heroSubtitle:
        "Reliable infrastructure with automated backups and a clear recovery plan if something goes wrong.",
      sectionHeading: "High-Availability Infrastructure for Energy Software",
      sectionBody:
        "Your business software is mission-critical; it cannot afford to be offline. Our hosting and disaster recovery service provides a secure, professionally managed cloud environment for your Glaban ERP and other energy systems. We move beyond simple hosting by implementing automated nightly backups to offsite locations and maintaining a rigorous disaster recovery plan. This ensures that even in the event of a hardware failure or data breach, your systems can be restored quickly with zero data loss, keeping your depots and stations running 24/7.",
      ctaLabel: "Request Consultation",
      layout: "grid",
      items: [
        "VPS setup",
  ...
  },
  {
    ...
    image: "/images/services/s11.png",
    listingDesc:
      "Hands-on training for owners, managers, and field staff to ensure smooth system adoption.",
    detail: {
      icon: Presentation,
      iconBg: orangeBg,
      iconColor: orangeColor,
      ...
      items: [
        "User training",
        "Admin training",
        "On-site support direction",
        "Remote support direction",
        "Maintenance packages",
        "Support request process",
        "Emergency support direction",
      ],
  ...
  },
  {
    ...
    listingIcon: Wrench,
    image: "/images/services/s12.png",
    listingDesc:
      "Keep your systems secure and up-to-date with our dedicated maintenance and support packages.",
    detail: {
      icon: Wrench,
      iconBg: orangeBg,
      iconColor: orangeColor,
      ...
      heroSubtitle:
        "Ongoing updates, monitoring, and dedicated support packages so your systems keep running long after launch.",
