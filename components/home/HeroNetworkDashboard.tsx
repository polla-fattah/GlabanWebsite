...
export default function HeroNetworkDashboard() {
  ...
  return (
    <div className="relative w-full">
      <Card className="bg-carbon border border-graphite rounded-lg p-6 shadow-none text-white overflow-hidden flex flex-col gap-6">
        {/* Top Header Bar */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-graphite gap-3">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-[10px] font-mono text-fog bg-obsidian border border-graphite px-2 py-0.5 rounded-lg">
              GLB-SYS-01
            </span>
          </div>
        ...
        <div className="grid grid-cols-3 gap-2 bg-obsidian p-1.5 border border-graphite rounded-lg">
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isSelected
                    ? "bg-carbon border-smoke text-white font-medium"
                    : "bg-transparent border-transparent text-fog hover:text-mist hover:bg-carbon/50",
                )}
              >
                <i
                  className={cn(
                    tab.icon,
                    isSelected ? "text-orange" : "text-fog",
                  )}
                />
              ...
              >
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-obsidian border border-graphite rounded-lg p-4">
                    <div className="flex justify-between items-center mb-1.5">
                      <span className="text-[11px] font-mono text-fog uppercase tracking-wider">
                        STATIONS ONLINE
                      </span>
                    ...
                    <div className="text-[11px] text-fog font-mono mt-1">
                ...
                <div className="bg-obsidian border border-graphite rounded-lg p-4">
                  <div className="flex justify-between items-center text-[12px] font-mono mb-2">
                    <span className="text-fog uppercase">
                  ...
                  <div className="h-1.5 rounded-lg bg-graphite overflow-hidden">
                    <div className="w-[82%] h-full bg-orange" />
                  </div>
                  <div className="flex justify-between items-center text-[10.5px] font-mono text-fog mt-2 pt-2 border-t border-graphite">
                    <span>TLS 1.3 ENCRYPTED EDGE BUFFER</span>
                    <span className="text-orange">&lt; 15ms Latency</span>
                  </div>
                </div>
              </motion.div>
            )}
            ...
            {activeTab === "quota" && (
              ...
              >
                ...
                <div className="bg-obsidian border border-graphite rounded-lg p-4">
                  ...
                  <div className="h-1.5 rounded-lg bg-graphite overflow-hidden">
                    <div className="w-[76.4%] h-full bg-orange" />
                  </div>
                  <div className="flex justify-between items-center text-[10.5px] font-mono text-fog mt-2 pt-2 border-t border-graphite">
            ...
            {activeTab === "surveillance" && (
              ...
              >
                ...
                <div className="bg-obsidian border border-graphite rounded-lg p-4">
                  ...
                  <div className="h-1.5 rounded-lg bg-graphite overflow-hidden">
                    <div className="w-[100%] h-full bg-orange" />
                  </div>
                  <div className="flex justify-between items-center text-[10.5px] font-mono text-fog mt-2 pt-2 border-t border-graphite">
                    <span>LOCAL NVR + CLOUD MIRROR</span>
                    <span className="text-orange">Zero Data Shrinkage</span>
                  </div>
                </div>
              </motion.div>
            )}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[13px] font-semibold text-white flex items-center gap-2">
                ...
                <span className="text-orange text-[10px] font-normal border border-graphite bg-carbon px-1.5 py-0.5 rounded-lg">
                  GUARANTEED
                </span>
              </div>
            </div>
