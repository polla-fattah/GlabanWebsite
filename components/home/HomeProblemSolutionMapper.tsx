  ...
  return (
    <section className="bg-void relative border-b border-graphite">
      ...
      <div 
        ...
        style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\\"20\\" height=\\"20\\" viewBox=\\"0 0 20 20\\" xmlns=\\"http://www.w3.org/2000/svg\\"%3E%3Cg fill=\\"%23ffffff\\" fill-opacity=\\"1\\" fill-rule=\\"evenodd\\"%3E%3Ccircle cx=\\"3\\" cy=\\"3\\" r=\\"1\\"%3E%3C/circle%3E%3C/g%3E%3C/svg%3E")' }}
      />
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    <span className="font-mono text-[24px] text-graphite">{prob.number}</span>
                ...
                {(() => {
                  return problems.map((prob, index) => {
                    ...
                    if (isPast) {
                      ...
                      opacity = Math.max(0, 0.4 - (activeProblemIndex - index) * 0.1); // Dim older cards
                    } else if (isActive) {
                      y = 0;
                      scale = 1;
                      opacity = 1;
